...
<body data-spy="scroll" data-target=".navbar-collapse" data-offset="50" id = "body-aboutus">
...
<section id="screenshot" style="background-color: #FFD700; height: 6em; width: 80%; margin-left: 10%;
margin-right: 10%; padding: 0;">

   
         <div class="overlay"></div>
          <div class="container" style=" margin-left: 10%; margin-right: 10%; width: 80%;">
                <p style="margin: 1em; text-align: center; font-size: 2em;">Why Bikeckub?</p>
...
<section id="screenshot" style="background-color: #fff; height: 80em; width: 80%; margin-left: 10%; padding: 0; text-align: center;" class="hidden-xs hidden-sm">


   
       <section style="margin-right: 10%; margin-left: 10%; border: 1px grey; border-bottom-style: solid;">
        <br>
         <p style="font-weight: bold;">RIGHT BIKE</p>
         <br>
         <p>เรามีจักรยานทุกประเภท จากแบรนด์จักรยานชั้นนำทั่วโลก มากกว่า 300 รุ่น ภายใต้หลังคาเดียว ภายใจ้ Concpet "Something For Everyone"
         <br>
         We have all the latest international brands more than 300 models full range. More brands under one roof "Something For Everyone" 
         </p>
         <br>
       </section>
       ...
       <section style="margin-right: 10%; margin-left: 10%; border: 1px grey; border-bottom-style: solid;">
        <br>
          <p style="font-weight: bold;">RIGHT FIT</p>
         <br>
         <p>เรามีเทคโนโลยีล่าสุดในการ Fitting จักรยานให้ถูกต้องตามสรีระร่างกายของคุณ เพื่อให้คุณได้จักรยานที่มีคุณภาพและเหมาะสมกับร่างกายเพื่อประสิทธิภาพสูงสุดในการออกกำลังกาย
         <br>
       ...
       <section style="margin-right: 10%; margin-left: 10%; border: 1px grey; border-bottom-style: solid;">
        <br>
          <p style="font-weight: bold;">RIGHT GEAR</p>
         <br>
         <p>นอกจากเราจะมีจักรยานแล้ว เรายังเตรียมอุปกรณ์เสริม, อะไหล่, เครื่องแต่งกาย รวมถึง Gadget จากแบรนด์ชั้นนำไว้ในสถานที่เดียว เพื่อเพิ่มความสะดวกสบายให้กับนักปั่นและลูกค้าทั่วไป
         <br>
       ...
       <section style="margin-right: 10%; margin-left: 10%; border: 1px grey; border-bottom-style: solid;">
         <br>
          <p style="font-weight: bold;">RIGHT SERVICE</p>
         <br>
         <p>นอกจากเราจะมีจักรยานแล้วเรายังมีอุปกรณ์เสริม, อะไหล่, เครื่องแต่งกายรวมถึง Gadget จากแบรนด์ชั้นนำไว้ในสถานที่เดียวเพื่อเพิ่มความสะดวกสบายให้กับนักปั่นและลูกค้าทั่วไป
         </p>
         <br>
       </section>
       ...
       <section style="margin-right: 10%; margin-left: 10%; border: 1px grey; border-bottom-style: solid;">
          <br>
          <p style="font-weight: bold;">RIGHT PLACE</p>
         <br>
         <p>เรามี bike club 5 สาขากระจายทุกภูมิภาคทั่วประเทศที่พร้อมจะให้บริการทุกท่านด้วยความชำนาญอย่างเป็นมืออาชีพ
         </p>
         <br>
       </section>
...
<section id="screenshot" style="background-color: #fff; height: 100em; width: 80%; margin-left: 10%; padding: 0; text-align: center;" class="visible-xs visible-sm">
