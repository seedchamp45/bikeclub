...
<section id="screenshot" style="background-color: #fff; height: 30em;">
  <div id="container">
  <?php 
  include_once("db_config.php");

  $db_check = $db->query("SELECT * FROM bike_new LIMIT 1");
  ...
  echo'
    <div id="content" style="float: left; width: 70%;">
        ...
        <img src="upload_new/'.$image_name.'" style="height: 20em;  margin: auto;">
       
  </div>

   <div id="content" style="float: right; width: 30%; padding-left: 2%; padding-right: 2%; margin-top: 2em;">
      <p style="font-weight: bold;">'. $promotion_time .'</p>
      <br>
      <p>' . $heading .'</p>
      <br>
      <p>' . $description .'</p>
...
<section id="screenshot" style="background-color: #fff; height: 35em;">
...
<section id="screenshot" style="background-color: #fff; height: 45em">
    ...
    <div class="row">
      <div class="col-md-offset-2 col-md-8 col-sm-12 hidden-sm hidden-xs">
        <div class="section-title">
            <h1 style="color: black;">#THEREALCLUB</h1>
          </div>
       </div>
        ...
        <?php
          ...
          $db_check = $db->query("SELECT * FROM real_club");
            while($rowdata = mysqli_fetch_assoc($db_check)){ //fetch values
              ...
              $description = $rowdata['description'];
                echo 
                '<div class="item col-md-3 col-sm-3 wow fadeInUp hidden-sm hidden-xs" data-wow-delay="0.9s" style="width: 100%;">
        ...
        <script>
          function load_contents(track_page){
           //show loading image
            ...
            $.post( 'fetch_data_pages_result_bike_news.php', {'page': track_page}, function(data){
