                         ...
                         <div class="container">
                              <div class="row" style="padding-right: 20%; text-align: right;">
                                   <!-- <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li> -->
                                        <a href="clean_bike.php" style="color: white; font-size: 3em;">CLEAN BIKE</a>
                                  <!--       </li>
                                   </ul>
 -->                              </div>
                         </div>    
...
<section id="screenshot" style="background-color: #fff; height: 65em;">
  ...
  <div id="content" style="float: left; width: 50%;">
      <p style="text-align: center;">CLEAN BIKE             SERVICE</p>

      <img src="images/clean-bike-1.png" style="width: 80%; margin-left: 10%;">
    

      <p style="text-align: center;  margin-top: 13em;">ล้างทำความสะอาด/ถอดเฟืองและโซ่/ปรับตั้งเกียร์</p>
   

  </div>

   <div id="content" style="float: right; width: 50%;">
      <p style="text-align: center;">BIG SERVICE CLEAN BIKE</p>

      <img src="images/clean-bike-2.png" style="width: 80%; margin-left: 10%;">

      <p style="text-align: center;  margin-top: 8em;"> ถอดเฟือง ตีนผีโซ่ เบรค และ ชุดจานหน้า ออกมาล้างที่ละชิ้นส่วน<br>
...
<section id="screenshot" style="background-color: #E8E8E8; height: 20em">

    <div id="container">
  <div id="content" style="float: left; width: 50%;">
      <p style="text-align: center; font-weight: bold;">บริการล้างจักรยานทั้งคัน</p>
   ...
   <div id="content" style="float: right; width: 50%;">
           <p style="text-align: center; font-weight: bold;">บริการล้าง Big Service ทั้งคัน</p>
