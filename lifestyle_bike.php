...
<section id="mountain-bike" class="hidden-sm hidden-xs">
                         ...
                         <div class="container">
                              <div class="row" style="padding-right: 20%; text-align: right;">
                                   <!-- <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li> -->
                                        <a href="mtb.html" style="color: white; font-size: 3em;">MOUNTAIN BIKE</a>
                                  <!--       </li>
                                   </ul>
 -->                              </div>
                         </div>    
...
<section id="mountain-bike-small"  class="visible-sm visible-xs" style=" 
    background: url('images/mountain-bike.png') no-repeat;
    background-size: 100%;
    margin-top: 60px;
    height: 100px;
    ...
    <div style="margin: auto;">
      <form method="post">
        <ul class="nav navbar-nav navbar-left" style="text-align: center;">
          ...
          <li style="padding: 1em;">PRICE RATE</li>
          ...
          <li style="padding: 1em;">
            <button class="btn btn-primary" id = "submitspec" style="background-color: white; padding-left: 7%; padding-right: 10%; color: black; border-color: black; width: 10em;" type="button">Submit
            </button>
          </li>
        </form>
      </ul>
...
<script src="https://unpkg.com/masonry-layout@4/dist/masonry.pkgd.js"></script>       <!-- Masonry (http://masonry.desandro.com/) -->
        ...
        function load_contents(track_page){
           //show loading image
            ...
            $.post( 'fetch_data_pages_lifestyle_bike.php', {'page': track_page}, function(data){
                    $("#results").append(data); 
            });
        ...
        function load_contents_spec(){
           ...
           $.ajax({
              url: "fetch_data_pages_lifestyle_bike_spec.php",
              method: "post",
