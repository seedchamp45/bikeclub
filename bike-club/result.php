...
<section id="screenshot" style="background-color: #fff; height: 45em;" class="hidden-xs hidden-sm">
  <div id="container">
  <?php 
  ...
  echo'
    <div id="content" style="float: left; width: 60%;">
      <section>
        <img src="upload/'.$pic_bike_1.'" style="width: 80%;  margin: auto;">
      </section>
   ...
   <div id="content" style="float: right; width: 40%; padding-left: 2%; padding-right: 2%; margin-top: 0.5em;">
     
      <p style="font-weight: bold; font-size:2em; color: black;">'. $brand .'</p>
      <br>
      <p style="font-size:1.5em;">' . $spec .'</p>
      <br>
       <table style="font-size:1em;">
        <tr>
          <td style="width: 50%;">COLORS:</td>
          <td style="color:rgb(152,152,152);">'. $color .'</td>
        </tr>
        <tr>
          <td>FRAME SIZES :</td>
          <td style="color:rgb(152,152,152);">' . $frame_sizes .'</td>
        </tr>
        <tr>
          <td>FRAME :</td>
          <td style="color:rgb(152,152,152);">' . $frame .'</td>
        </tr>
        <tr>
          <td>FORK :</td>
          <td style="color:rgb(152,152,152);">' . $fork .'</td>
        </tr>
        <tr>
          <td>DERAILLEUR FRONT :</td>
          <td style="color:rgb(152,152,152);">' . $derailleur_front .'</td>
        </tr>
        <tr>
          <td>DERAILLEUR REAR :</td>
          <td style="color:rgb(152,152,152);">' . $derailleur_rear .'</td>
        </tr>
        <tr>
          <td>SHIFTER : </td>
          <td style="color:rgb(152,152,152);">' . $shifters .'</td>
        </tr>
        <tr>
          <td>BRAKES LEVER : </td>
          <td style="color:rgb(152,152,152);">' . $break_lever .'</td>
        </tr>
        <tr>
          <td>BRAKES :</td>
          <td style="color:rgb(152,152,152);">' . $brakes .'</td>
        </tr>
      ...
      <br>
      <p style="width: 80%; background-color: #FFCC33; color: black; margin: auto; text-align: center; height: 2em; font-size: 3em; padding-top: 0.7em;">
        ' . $price .'
      </p>
      </div>';
}
        ...
        <script>
          function load_contents(track_page){
           //show loading image
            ...
            $.post( 'fetch_data_pages_result', {'page': track_page}, function(data){
