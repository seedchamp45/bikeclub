...
<section style="  background: url('images/fit-a-bike-background.png') no-repeat;
  ...
  $email = $_POST["email"];
  $tel = $_POST["tel"];
  echo '<div style = "display:none:"><input type="text" name = "name" style = "opacity: 0;" value ="' .$name . '"/><input type="text" name = "email" style = "opacity: 0;" value ="' .$email . '"/><input type="text" name = "tel" style = "opacity: 0;" value ="' .$tel . '"/></div>';
  ...
  <div id="content" style="display: inline-block; width: 30.33%; margin-right: 1.5%; margin-left: 1.5%; margin-top: 4%;">
    ...
    <select  name="height" id="category" style="width: 100%;">
  ...
  <div id="content" style="float: right; width: 30.33%; margin-right: 1.5%; margin-left: 1.5%; margin-top: 4%;">
   <p style="color: white;">BIKE TYPE</p>
      <select  name="height" id="category" style="width: 100%;">
        ...
        <option value="LIFESTYLE BIKE">LIFESTYLE BIKE</option>
