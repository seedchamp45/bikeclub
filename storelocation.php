      ...
      <div class="tm-img-gallery-container" >
        ...
        <!-- Gallery One pop up connected with JS code below -->
          <div class="grid-item">
              ...
              <p style="font-size: 0.9em; text-align: center;">BIKE CLUB - CHAIYAPRUK</p>
              <br>
              <p style="font-size: 0.7em; text-align: center;">54/8 หมู่ 2 ถนนราชพฤกษ์ ตำบลบางพลับ <br> อำเภอปากเกร็ด นนทบุรี 11120</p>
              <br>
              <p style="font-size: 0.7em; text-align: center;">CALL: 02-0297254</p>
              <p style="font-size: 0.7em; text-align: center;">OPEN: 09:00 AM - 10:00 AM</p>
              <br>
              <a href="mtb.html" class="smoothScroll">GET DIRECTION</a></li>
              <br>
              <p style="opacity: 0;">.</p>
          </div>
