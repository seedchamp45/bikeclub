...
<section style="  background: url('images/signup_form.png') no-repeat;
  ...
  <div class="overlay"></div>
    <div class="container" style="margin: auto; padding: auto; width: 50%;">
      ...
      <div style="height: 60%; margin-top: 5%;">
        <form action="fit-a-bike.php" method="post" enctype="multipart/form-data">
    ...
    <p style="color: white;">NAME</p>
     <input type="text" name="name" id="frame_sizes" placeholder="NAME">
  ...
  <div id="content" style="display: inline-block; width: 100%; margin:auto;">
    ...
    <p style="color: white;">EMAIL</p>
     <input type="text" name="email" id="frame_sizes" placeholder="EMAIL">


      </div>
  <div id="content" style="float: right; width: 100%; margin:auto; padding: auto;">
   <p style="color: white;">TEL</p>
       <input type="text" name="tel" id="frame_sizes" placeholder="TEL">
    </div>
